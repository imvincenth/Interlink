...
class EditEducationForm extends React.Component {
  constructor(props) {
    ...
    this.oldEndMon = this.oldEndMon ? this.props.education.end_date.split(" ")[0] : "";
    this.oldEndYr = this.oldEndYr ? this.props.education.end_date.split(" ")[1] : "";
  ...
  setStartTime() {
    if (!this.state.start_date) return this.setState({ start_date: `${this.props.education.start_date}` })
    this.setState({ 
  ...
  setEndTime() {
    if (!this.state.end_date) return this.setState({ end_date: `${this.props.education.end_date}` })
